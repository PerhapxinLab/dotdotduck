...
Under the hood `useSurface` subscribes to the `surface` event and exposes the most recent payload + helpers. See [surface-renderer](../surfaces/renderer.md) for the data shape.
